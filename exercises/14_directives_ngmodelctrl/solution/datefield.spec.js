describe('datefield', function () {
  ...
  describe('format', function () {
    ...
    it('should format a valid date with a default format (YYYY/MM/DD)', function () {
      ...
      var elm = compileElement('<form name="f"><input name="i" ng-model="model" moment-datefield></form>', $scope);
    ...
    it('should format a valid date with a specified format (YYYY-MM-DD)', function () {
      $scope.model = new Date(0);
      var elm = compileElement('<form name="f"><input name="i" ng-model="model" moment-datefield="YYYY-MM-DD"></form>', $scope);
